...
namespace Melodrive
{
    ...
    public class MelodrivePlugin : MonoBehaviour
    {
        ...
        private static Dictionary<Ensemble, string> EnsembleMap = new Dictionary<Ensemble, string> {
            ...
            { Ensemble.CinematicAmbient,    "ambient:2" },
            { Ensemble.DreamyAmbient,       "ambient:3" },
            { Ensemble.ChiptuneAmbient,     "ambient:chip" },

            { Ensemble.ElectroHouse,    "house:1" },
            { Ensemble.DreamyHouse,     "house:2" },
            { Ensemble.FunkyHouse,      "house:3" },
            { Ensemble.MinimalHouse,    "house:4" },
            { Ensemble.ChiptuneHouse,   "house:chip" },

            { Ensemble.DreamyPiano,     "piano:1" },
            { Ensemble.DanceyPiano,     "piano:2" },
            { Ensemble.CinematicPiano,  "piano:3" },
            { Ensemble.ChiptunePiano,   "piano:chip" },

            { Ensemble.ClassicRock,     "rock:1" },
            { Ensemble.PianoRock,       "rock:2" },
            { Ensemble.EpicRock,        "rock:3" },
            { Ensemble.ElectroRock,     "rock:4" },
            { Ensemble.ChiptuneRock,    "rock:chip" },
        };
        ...
        public const string DLL_NAME = "AudioPlugin_Melodrive";
